class Solution:
    def isValidSerialization(self, preorder: str) -> bool:
        ...
        for node in p:
            ...
            # for every # encountered by us, we will reduce node of slot by 1, as already used
            if node=="#": slot-=1
            
            # for every normal number encountered, we will increase the slots by 1. As -1+2. 
