...
<pre style="position: relative;"><strong>Input:</strong> locations = [2,3,6,8,4], start = 1, finish = 3, fuel = 5
...
<pre style="position: relative;"><strong>Input:</strong> locations = [4,3,1], start = 1, finish = 0, fuel = 6
...
<pre style="position: relative;"><strong>Input:</strong> locations = [5,2,1], start = 0, finish = 2, fuel = 3
