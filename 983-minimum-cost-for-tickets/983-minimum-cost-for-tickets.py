class Solution:
    def mincostTickets(self, days: List[int], costs: List[int]) -> int:
        ...
        def solve(days, costs, idx):
            """
            This function's job is to return what is cheapest from idx to nth index. 
            We go in a top down fashion, and try all the possibilities, and come to conclusion. 
            """
